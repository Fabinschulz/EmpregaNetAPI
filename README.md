...
12. [Gerenciamento de estado](#14-gerenciamento-de-estado)
13. [Estratégia de cache](#15-estratégia-de-cache)
14. [Tratamento de erros e exceções](#16-tratamento-de-erros-e-exceções)
15. [Configurando o ambiente de desenvolvimento](#17-configurando-o-ambiente-de-desenvolvimento)
16. [Variáveis de ambiente](#18-variáveis-de-ambiente)
17. [Executando o projeto localmente](#19-executando-o-projeto-localmente)
18. [Convenções do projeto](#22-convenções-do-projeto)

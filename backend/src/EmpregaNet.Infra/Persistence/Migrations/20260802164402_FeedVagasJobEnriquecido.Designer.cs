...
namespace EmpregaNet.Infra.Persistence.Migrations
{
    ...
    [Migration("20260802164402_FeedVagasJobEnriquecido")]
    partial class FeedVagasJobEnriquecido
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmpregaNet.Domain.Entities.Job", b =>
                {
                    ...
                    b.HasIndex("Technologies")
                        .HasDatabaseName("IX_Jobs_Technologies");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Technologies"), "gin");
